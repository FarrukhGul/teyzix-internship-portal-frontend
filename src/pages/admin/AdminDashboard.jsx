      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-6 md:py-8 pb-24 md:pb-8">
        ...
        {activeTab === 'overview' && (
          <div className="flex flex-col gap-6 md:gap-8">
            ...
            {/* Stat Cards — alternating left/right */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
              {[
                { label: 'Total Applications', value: applications.length, color: 'green', dir: 'left' },
                { label: 'Total Internships',  value: internships.length,  color: 'green', dir: 'right' },
                { label: 'Open Positions',     value: openApps,            color: 'green', dir: 'left' },
                { label: 'Closed Positions',   value: closedApps,          color: 'red',   dir: 'right' },
              ].map((stat, i) => (
                <motion.div
                  key={i}
                  className="bg-[#111] border border-green-900/30 rounded-xl p-4 md:p-5 flex flex-col gap-1 md:gap-2"
                  initial={{ opacity: 0, x: stat.dir === 'left' ? -40 : 40 }}
                  animate={{ opacity: 1, x: 0 }}
            ...
            {/* Recent Applications section — from bottom */}
            <motion.div
              {...fromBottom}
            ...
            {/* Active Internships section — from bottom */}
            <motion.div
              {...fromBottom}
